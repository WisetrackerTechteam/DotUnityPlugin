...
public class DOT {
    ...
    public static void initialization()
    {
        ...
        {
            unityHelperInstance.Call("initialization", context);
        }
    }
    ...
    public static void setPushReceiver(string campaignId, string pushID)
    {
        ...
        if (unityHelperInstance != null)
        {
            unityHelperInstance.Call("setPushReceiver", context, campaignId, pushID);
        }
    }
    ...
    public static void setPushClick(string pushId, string campaignId, string pushTitle, string pushBody, long expireTime)
    {
        ...
        if (unityHelperInstance != null)
        {
            unityHelperInstance.Call("setPushClick", context, pushId, campaignId, pushTitle, pushBody, expireTime);
        }
    }
    ...
    public static void setDeepLink(string url)
    {
        ...
        if (unityHelperInstance != null)
        {
            unityHelperInstance.Call("setDeepLink", context, url);
        }
    }

    public static void setInstallReferrer(string url, long beginTime)
    {
        Debug.Log("set install referrer");
        if (unityHelperInstance != null)
        {
            unityHelperInstance.Call("setInstallReferrer", context, url, beginTime);
        }
    }

    public static void setFacebookReferrerData(string targetUrl)
    {
        Debug.Log("set facebook referrer");
        if (unityHelperInstance != null)
        {
            unityHelperInstance.Call("setFacebookReferrerData", context, targetUrl);
        }
    }
    ...
    public static void onStopPage()
    {
        if (unityHelperInstance != null)
        {
            Debug.Log("move to background");
            unityHelperInstance.Call("onStopPage", context);
        }
    }
